"""Instance segmentation on the SiMa Modalix DevKit -- compatibility entry point.

Finds instances, draws their masks and optionally blurs the background.
...
The same run, through the installed CLI::
    ...
    sima-vision segment --config config.yaml
