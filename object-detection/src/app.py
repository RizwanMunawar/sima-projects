"""Object detection on the SiMa Modalix DevKit -- compatibility entry point.
...
The same run, through the installed CLI::
    ...
    sima-vision detect --config config.yaml
    sima-vision detect --config config.yaml --validate
